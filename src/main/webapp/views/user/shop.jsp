											...
											<c:forEach items="${categories }" var="category">
												<li>
													<div class="d-flex justify-content-between fruite-name">
														<a href="shop/search?cate_id=${category.id }"
								...
								<div class="col-12">
									<div class="pagination d-flex justify-content-center mt-5">
										<c:if test="${currentPage == 1 }">
											<a href="#" class="rounded btn disabled">&laquo; </a>
										</c:if>

										<c:if test="${currentPage > 1 }">
											<a href="shop?page=${currentPage - 1 }" class="rounded">&laquo;</a>
										</c:if>
										<c:forEach varStatus="i" begin="1" end="${maxPage }">
											<a href="shop?page=${i.index }"
												class="rounded ${currentPage == i.index ? 'active' : '' }">${i.index }</a>
										</c:forEach>

										<c:if test="${currentPage == maxPage }">
											<a href="#" class="rounded btn disabled">&raquo;</a>
										</c:if>

										<c:if test="${currentPage < maxPage }">
											<a href="shop?page=${currentPage + 1 }" class="rounded">&raquo;</a>
										</c:if>
