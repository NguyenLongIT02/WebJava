			...
			<%@ include file="cart.jsp" %>
				...
				<div class="container-fluid py-5">
					<div class="container py-5">
						...
						<form action="<%=request.getContextPath()%>/finalOrder" method="POST">
							<div class="row g-5">
								<div class="col-md-12 col-lg-5 col-xl-5">
									<div class="form-item">
										<label class="form-label my-3">Họ Tên<sup></sup></label> <input type="text"
											class="form-control" />
									</div>
									<div class="form-item">
										<label class="form-label my-3">Email <sup></sup></label> <input type="text"
											class="form-control" placeholder="(Tùy Chọn)" />
									</div>
									<div class="form-item">
									...
									<div class="form-item">
										<label class="form-label my-3">Địa Chỉ<sup>*</sup></label> <input type="text"
											class="form-control" />
									</div>

									<!-- Delivery Date & Time -->
									<div class="form-item">
										<label class="form-label my-3">Ngày Giao Hàng<sup>*</sup></label>
										<input type="date" name="deliveryDate" class="form-control" required />
									</div>
									<div class="form-item">
										<label class="form-label my-3">Giờ Giao Hàng<sup>*</sup></label>
									...
									<div class="form-check my-3">
										<input type="checkbox" class="form-check-input" id="Account-1" name="Accounts"
											value="Accounts" /> <label class="form-check-label" for="Account-1">Thanh
											Toán Khi
											Đặt Hàng </label>
									</div>
									<hr />
									<div class="form-item">
										<textarea name="text" class="form-control" spellcheck="false" cols="30" rows="4"
													...
													<tr>
														<th scope="row">
															<div class="d-flex align-items-center mt-2">
																<img src="<c:url value='templates/user/img/${map.value.product.image }' />"
