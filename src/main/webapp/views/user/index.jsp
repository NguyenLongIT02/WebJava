										...
										<div class="col-lg-12">
											<div class="row g-4">
												<c:forEach items="${products }" var="product" begin="0" end="11">
													<c:url value="/templates/user/img/${product.image }" var="imgUrl">
													</c:url>
														...
														<div class="rounded position-relative fruite-item"
															...
															<div class="text-white bg-secondary px-3 py-1 rounded position-absolute"
																...
																<a href="<c:url value='product?action=detail&id=${product.id}'/>"
																	style="color: #FFFFFF;"> ${product.category.name }
																</a>
															</div>
															<div
																...
																<div
																	...
																	<p class="text-dark fs-5 fw-bold mb-0">
																		<a href="<c:url value='product?action=detail&id=${product.id}'/>"
																			style="color: black;"> ${product.price}$
																		</a>
																	</p>
																	<a href="<c:url value='product?action=add&pId=${product.id}&quantity=1'/>"
							...
							<c:forEach items="${products }" var="product" begin="6" end="9">
								<div class="col-md-6 col-lg-6 col-xl-3">
									<div class="text-center">
										<a href="<c:url value='product?action=detail&id=${product.id}'/>">
											<img src="<c:url value='/templates/user/img/${product.image }' />"
												class="img-fluid img-fluid rounded w-100" alt=""
							...
							<div class="row g-4 justify-content-center">
								<div class="col-md-6 col-lg-6 col-xl-3">
									<div class="counter bg-white rounded p-5">
										...
										<h4 style="font-family: 'Times New Roman', Times, serif !important;">Khách
											Hàng Hài Lòng</h4>
										<h1 style="font-family: 'Times New Roman', Times, serif !important;">1963</h1>
									</div>
								</div>
								<div class="col-md-6 col-lg-6 col-xl-3">
									<div class="counter bg-white rounded p-5">
										<i class="fa fa-users text-secondary"></i>
										<h4 style="font-family: 'Times New Roman', Times, serif !important;">Chất
											Lượng Dịch Vụ</h4>
										<h1 style="font-family: 'Times New Roman', Times, serif !important;">99%</h1>
									</div>
								</div>
								<div class="col-md-6 col-lg-6 col-xl-3">
									<div class="counter bg-white rounded p-5">
										<i class="fa fa-users text-secondary"></i>
										<h4 style="font-family: 'Times New Roman', Times, serif !important;">Chứng
											Nhận Chất Lượng</h4>
										<h1 style="font-family: 'Times New Roman', Times, serif !important;">33</h1>
									</div>
								</div>
								<div class="col-md-6 col-lg-6 col-xl-3">
									<div class="counter bg-white rounded p-5">
										<i class="fa fa-users text-secondary"></i>
										<h4 style="font-family: 'Times New Roman', Times, serif !important;">Sản
											Phẩm Hiện Có</h4>
										<h1 style="font-family: 'Times New Roman', Times, serif !important;">789</h1>
									</div>
								</div>
							</div>
						</div>
								...
								<div class="position-relative">
									...
									<div class="d-flex align-items-center flex-nowrap">
										<div class="bg-secondary rounded">
											<img src="<c:url value='templates/user/img/testimonial-1.jpg' />"
