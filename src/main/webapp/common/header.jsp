			...
			<div class="d-flex justify-content-between">
				<div class="top-info ps-2">
					<small class="me-3"><i class="fas fa-map-marker-alt me-2 text-secondary"></i> <a href="contact"
							class="text-white">Số 5,Văn Trì, Bắc Từ Liêm,
							Hà Nội</a></small> <small class="me-3"><i class="fas fa-envelope me-2 text-secondary"></i><a
							href="contact" class="text-white">Onlinefoodshoping@gmai.com</a></small>
				</div>
				<div class="top-link pe-2">
					<a href="#" class="text-white"><small class="text-white mx-2">Privacy
							Policy</small>/</a> <a href="#" class="text-white"><small class="text-white mx-2">Terms of
							Use</small>/</a> <a href="#" class="text-white"><small class="text-white ms-2">Sales
							and Refunds</small></a>
				</div>
			</div>
		</div>
			...
			<nav class="navbar navbar-light bg-white navbar-expand-xl">
				...
				<div class="collapse navbar-collapse bg-white" id="navbarCollapse">
					<div class="navbar-nav mx-auto">
						<a href="${pageContext.request.contextPath}/index" class="nav-item nav-link active">Trang
							chủ</a> <a href="${pageContext.request.contextPath}/shop" class="nav-item nav-link">Shop</a>
						<a href="${pageContext.request.contextPath}/introduce" class="nav-item nav-link">Giới thiệu</a>
						<div class="nav-item dropdown">
							<a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Sản Phẩm</a>
							<div class="dropdown-menu m-0 bg-secondary rounded-0">
								<a href="cart.html" class="dropdown-item">Cart</a> <a href="chackout.html"
									class="dropdown-item">Checkout</a> <a href="testimonial.html"
									class="dropdown-item">Testimonial</a> <a href="404.html" class="dropdown-item">404
									Page</a>
							</div>
						</div>
					...
					<div class="d-flex m-3 position-relative me-0 my-auto">
						<div class="input-group w-100 my-auto d-flex position-relative" style="margin-right: 10px">
							<input type="search" class="me-0 my-auto p-3 form-control" placeholder="Nhập từ cần tìm"
					...
					<c:if test="${not empty sessionScope.cart}">
						<c:forEach var="entry" items="${sessionScope.cart}">
							<c:set var="totalQuantity" value="${totalQuantity + entry.value.quantity}" />
						</c:forEach>
					</c:if>
					<button class="position-relative me-4 my-auto bg-white border-0" data-bs-toggle="modal"
							...
							<c:choose>
								<c:when test="${not empty sessionScope.currentUser}">
									<a href="<c:url value='account' />"
										class="dropdown-item">${sessionScope.currentUser.username}</a>
